		...
		try {
			...
			RegisterStudentHandler objCommandEventHandler6 =
				new RegisterStudentHandler(
					...
					EventBus.EV_SHOW);
			CourseOverbookMonitor courseOverbookMonitor =
				new CourseOverbookMonitor(
					db,
					EventBus.EV_REGISTER_STUDENT,
					EventBus.EV_SHOW
					);
			CourseRegisterConflictChecker courseRegisterConflictChecker =
				new CourseRegisterConflictChecker(
					db,
					EventBus.EV_CONFLICT,
					EventBus.EV_SHOW);
